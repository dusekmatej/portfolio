...
const Navigation = ( { isDarkMode, setIsDarkMode}) => {
    return (
        <nav >
            <ul className='text-[25px] gap-12 flex dark:bg-[#201f22] dark:text-white p-4 justify-center light:bg-white'> 
                    ...
                    <li><button className="hover:shadow-[0_0_135px_50px_rgba(0,34,120,1)] hover:bg-[#00227872] cursor-pointer" onClick={() => setIsDarkMode(prev => !prev)}><i className="fa-solid fa-moon"></i></button></li>
            </ul>
        </nav>
    )
}
